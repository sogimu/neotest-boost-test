local Storage = require("neotest-boost-test.storage")
local utils = require("neotest-boost-test.utils")
local lib = require("neotest.lib")
local neotest = require("neotest")

local ADAPTER_PREFIX = "neotest-boost-test:"
...
---@class neotest-boost-test.ExecutablesRegistry
---@field _root_dir string
---@field _storage neotest-boost-test.Storage
